# MyFLicks a flask-based web application that allows users to create and manage personal movie watchlists. Users can explore movie details fetched from the TMDB API and add movies to their lists. 
